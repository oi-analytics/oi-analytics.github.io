  ...
  <li class="team-list-item">
    ...
    <div class="team-meta">
      ...
      <p class="team-list-desc">Researcher at OPSIS, University of Oxford</p>
        ...
        <li class="team-list-item">
    <img class="team-image" src="/assets/img/team-karla.jpg" alt="Karla Cervantes Barron">
    <div class="team-meta">
      <h3 class="team-list-name">Dr Karla Cervantes Barron</h3>
      <p class="team-list-title">OIA Expert</p>
      <p class="team-list-desc">Consultant at Imperial College London</p>
    </div>
  </li>
</ul>
